...
namespace Business.Concrete
{
    ...
    {
        public string FileSaveToServer(IFormFile file, string filePath)//Database e kaydet
        {
        ...
        public string FileSaveToFtp(IFormFile file)// önerilen
        {
            var fileFormat = file.FileName.Substring(file.FileName.LastIndexOf('.'));
            fileFormat = fileFormat.ToLower();
            string fileName = Guid.NewGuid().ToString() + fileFormat;
        ...
        public byte[] FileConvertByteArrayToDatabase(IFormFile file)//Resmi byte array yapar
        {
