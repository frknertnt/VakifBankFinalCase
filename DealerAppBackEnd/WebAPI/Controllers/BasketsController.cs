...
namespace WebApi.Controllers
{
    ...
    public class BasketsController : ControllerBase
    {
        ...
        [HttpPost("[action]/{basketId}/{isIncrease}")]
        public async Task<IActionResult> UpdateQuantity(int basketId, bool isIncrease)
        {
            var result = await _basketService.UpdateQuantity(basketId, isIncrease);
            if (result.Success)
            {
                return Ok(result);
            }
