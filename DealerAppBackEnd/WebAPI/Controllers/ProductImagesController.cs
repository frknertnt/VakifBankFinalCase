...
namespace WebApi.Controllers
{
    ...
    public class ProductImagesController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        public async Task<IActionResult> Add([FromForm] ProductImageAddDto productImageAddDto)//Bir classýn içerisinde IFormFile dahil edilirse FromForm olarak gönderilmesi gerekir
        {
